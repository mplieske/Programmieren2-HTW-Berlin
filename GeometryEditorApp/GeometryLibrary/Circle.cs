...
namespace GeometryLibrary
{
    ...
    public class Circle : Curve, ISurface
    {
        ...
        public override void Draw(System.Drawing.Graphics g)
        {
            ...
            System.Drawing.RectangleF rect = new System.Drawing.RectangleF(x, y, width, width); // Circle has same width and height.
            g.DrawEllipse(DrawPen, rect); // Ellipse with same width and height is a circle.
        }
    }
}
